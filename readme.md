...
Tracy 2.5.12 requires PHP version 5.4.4 or newer (supports PHP up to 8.0) and is compatible with Chrome 49+, Firefox 45+, MS Edge 12+, Safari 10+ and iOS Safari 10.2+.
